...
Com isto, os autores do blog do MongoDB, disponibilizaram uma série de padrões de modelagem do banco de dados, criadas à partir do conhecimento adquirido na consultoria à clientes, representados na figura 1.
...
\end{center}
	\begin{tikzpicture}
		\umlclass[x=2,y=-10]{Producao}{  
			titulo : string \\ 
			ano : numeric \\
			duracao: numeric \\
			paises: string[] \\
			produtores: productor[] \\
			score\under by\under users : numeric \\
			avaliacoes\under users: evaluation[] \\
			cadastrado\under por: user \\
			descricao: string \\
			tipo\under producao:   				
		}{}
