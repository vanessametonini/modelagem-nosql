...
\end{center}
	...
	% entidades
		% pacote producao
		\begin{umlpackage}[x=0, y=0]{Producao}
			\umlclass[x=0,y=-10]{Producao}{  
				titulo: string \\ 
				resumo: string \\ 
				descricao: string \\
			...
			\umlclass[x=0,y=10]{Sequencia}{  
				ordem: numeric \\ 
				antecessorId: string \\ 
				sucessorId: string \\ 
			}{}
	
			\umlclass[x=100,y=-10]{Personagens}{  
				nome: string \\ 
				atuadoPorId: string \\ 
			}{}
	
			\umlclass[x=8,y=-20]{AvaliacaoArtista}{  
				artistaId: string \\ 
				notaMedia: numeric \\ 
				avaliacao: object \\ 
			}{}
	
			\umlclass[x=8,y=-20]{Avaliacao}{  
				usuarioId: string \\ 
				nota: numeric \\ 
			}{}
			...
			\umlclass[x=15,y=-15]{AvaliacaoDosUsuarios}{  
				data: string \\
				usuarioId: string \\
				producaoId: string \\
				nota: numeric \\
		...
		\umlclass[x=15,y=-15]{AtuacaoTipo}{  
			musical: boolean \\
			cinema: boolean \\
			direcao: boolean \\
		...
		\umlclass[x=15,y=-15]{Produtora}{  
			nome: string \\
			pais: string \\
		}{}

		\umlclass[x=15,y=-15]{Generos}{  
		}{
			nome: string \\ 
			producoesId: string[] \\ 
			musical: boolean \\ 
		...
		% relacionamentos
		% \umlunicompo[arg=z,mult=1..∗,pos=0.8,angle1=−90,angle2=−140]{Producao}{Filme} 
